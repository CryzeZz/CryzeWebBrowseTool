...
;(function($){
    ...
    if(!excelJSLoaded){
        ...
        LoadJS('//www.zhangxiang.me/jslib/xlsx/easyui.xlsx.js','utf-8');
        LoadJS('//www.zhangxiang.me/jslib/xlsx/bootstrapTable.xlsx.js','utf-8');
        LoadJS('//www.zhangxiang.me/jslib/xlsx/extjs.xlsx.js','utf-8');
        excelJSLoaded=true;
    }
